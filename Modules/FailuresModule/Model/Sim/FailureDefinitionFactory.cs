  ...
  public class FailureDefinitionFactory
  {
    ...
    private static List<FailureDefinition> BuildInstrumentFailures()
    {
      NameTriple[] vars =
      {
        ...
        //new("pnlAvionics", "Avionics (panel)","PARTIAL PANEL AVIONICS"), //read-only
        new("pnlEngine", "Engine (panel)", "PARTIAL PANEL ENGINE"),
        //new("pnlFuel", "Fuel indicator (panel)","PARTIAL PANEL FUEL INDICATOR"),  //read-only
        ...
        //new("pnlTurn", "Turn coordinator (panel)", "PARTIAL PANEL TURN COORDINATOR"),  //read-only

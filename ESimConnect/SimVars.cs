  ...
  public static class SimVars
  {
    public static class Aircraft
    {
      public static class Miscelaneous
      {
        ...
        public const string STRUCT_ENGINE_POSITION__index = "STRUCT ENGINE POSITION:index";
      ...
      public static class Autopilot
      {
        ...
        public const string AUTOPILOT_ALTITUDE_LOCK_VAR = "AUTOPILOT ALTITUDE LOCK VAR";
        ...
        public const string AUTOPILOT_BANK_HOLD_REF = "AUTOPILOT BANK HOLD REF";
        ...
        public const string AUTOPILOT_FLIGHT_LEVEL_CHANGE = "AUTOPILOT FLIGHT LEVEL CHANGE";
        ...
        public const string AUTOPILOT_HEADING_LOCK_DIR = "AUTOPILOT HEADING LOCK DIR";
        public const string AUTOPILOT_HEADING_MANUALLY_TUNABLE = "AUTOPILOT HEADING MANUALLY TUNABLE";
        ...
        public const string AUTOPILOT_THROTTLE_MAX_THRUST = "AUTOPILOT THROTTLE MAX THRUST";
        public const string AUTOPILOT_VERTICAL_HOLD = "AUTOPILOT VERTICAL HOLD";
        public const string AUTOPILOT_VERTICAL_HOLD_VAR = "AUTOPILOT VERTICAL HOLD VAR";
      ...
      public static class BrakesAndLandingGear
      {
        ...
        public const string BRAKE_LEFT_POSITION = "BRAKE LEFT POSITION";
        public const string BRAKE_LEFT_POSITION_EX1 = "BRAKE LEFT POSITION EX1";
        ...
        public const string BRAKE_RIGHT_POSITION = "BRAKE RIGHT POSITION";
        public const string BRAKE_RIGHT_POSITION_EX1 = "BRAKE RIGHT POSITION EX1";
        ...
        public const string CONTACT_POINT_COMPRESSION__index = "CONTACT POINT COMPRESSION:index";
        public const string CONTACT_POINT_IS_ON_GROUND__index = "CONTACT POINT IS ON GROUND:index";
        public const string CONTACT_POINT_IS_SKIDDING__index = "CONTACT POINT IS SKIDDING:index";
        public const string CONTACT_POINT_POSITION__index = "CONTACT POINT POSITION:index";
        public const string CONTACT_POINT_SKIDDING_FACTOR__index = "CONTACT POINT SKIDDING FACTOR:index";
        public const string CONTACT_POINT_WATER_DEPTH__index = "CONTACT POINT WATER DEPTH:index";
        ...
        public const string GEAR_ANIMATION_POSITION__index = "GEAR ANIMATION POSITION:index";
        public const string GEAR_AUX_POSITION = "GEAR AUX POSITION";
        ...
        public const string GEAR_CENTER_POSITION = "GEAR CENTER POSITION";
        ...
        public const string GEAR_HANDLE_POSITION = "GEAR HANDLE POSITION";
        public const string GEAR_HYDRAULIC_PRESSURE = "GEAR HYDRAULIC PRESSURE";
        public const string GEAR_IS_ON_GROUND__index = "GEAR IS ON GROUND:index";
        public const string GEAR_IS_SKIDDING__index = "GEAR IS SKIDDING:index";
        public const string GEAR_LEFT_POSITION = "GEAR LEFT POSITION";
        ...
        public const string GEAR_POSITION__index = "GEAR POSITION:index";
        public const string GEAR_RIGHT_POSITION = "GEAR RIGHT POSITION";
        ...
        public const string GEAR_STEER_ANGLE__index = "GEAR STEER ANGLE:index";
        public const string GEAR_STEER_ANGLE_PCT__index = "GEAR STEER ANGLE PCT:index";
        public const string GEAR_TOTAL_PCT_EXTENDED = "GEAR TOTAL PCT EXTENDED";
        public const string GEAR_WARNING__index = "GEAR WARNING:index";
        ...
        public const string NOSEWHEEL_MAX_STEERING_ANGLE = "NOSEWHEEL MAX STEERING ANGLE";
        ...
        public const string WATER_RUDDER_HANDLE_POSITION = "WATER RUDDER HANDLE POSITION";
        public const string WHEEL_ROTATION_ANGLE__index = "WHEEL ROTATION ANGLE:index";
        public const string WHEEL_RPM__index = "WHEEL RPM:index";
      }
      ...
      public static class Control
      {
        ...
        public const string AILERON_POSITION = "AILERON POSITION";
        ...
        public const string AILERON_TRIM_PCT = "AILERON TRIM PCT";
        ...
        public const string ELEVATOR_POSITION = "ELEVATOR POSITION";
        ...
        public const string ELEVATOR_TRIM_POSITION = "ELEVATOR TRIM POSITION";
        ...
        public const string FLAP_POSITION_SET = "FLAP POSITION SET";
        public const string FLAP_SPEED_EXCEEDED = "FLAP SPEED EXCEEDED";
        public const string FLAPS_AVAILABLE = "FLAPS AVAILABLE";
        public const string FLAPS_EFFECTIVE_HANDLE_INDEX__index = "FLAPS EFFECTIVE HANDLE INDEX:index";
        public const string FLAPS_HANDLE_INDEX__index = "FLAPS HANDLE INDEX:index";
        ...
        public const string LEADING_EDGE_FLAPS_LEFT_PERCENT = "LEADING EDGE FLAPS LEFT PERCENT";
        ...
        public const string LEADING_EDGE_FLAPS_RIGHT_PERCENT = "LEADING EDGE FLAPS RIGHT PERCENT";
        ...
        public const string TRAILING_EDGE_FLAPS_LEFT_PERCENT = "TRAILING EDGE FLAPS LEFT PERCENT";
        ...
        public const string TRAILING_EDGE_FLAPS_RIGHT_PERCENT = "TRAILING EDGE FLAPS RIGHT PERCENT";
        ...
        public const string FOLDING_WING_LEFT_PERCENT = "FOLDING WING LEFT PERCENT";
        public const string FOLDING_WING_RIGHT_PERCENT = "FOLDING WING RIGHT PERCENT";
        ...
        public const string RUDDER_PEDAL_POSITION = "RUDDER PEDAL POSITION";
        public const string RUDDER_POSITION = "RUDDER POSITION";
        public const string RUDDER_TRIM = "RUDDER TRIM";
        public const string RUDDER_TRIM_DISABLED = "RUDDER TRIM DISABLED";
        public const string RUDDER_TRIM_PCT = "RUDDER TRIM PCT";
        public const string SPOILERS_ARMED = "SPOILERS ARMED";
        public const string SPOILER_AVAILABLE = "SPOILER AVAILABLE";
        public const string SPOILERS_HANDLE_POSITION = "SPOILERS HANDLE POSITION";
        ...
        public const string BLAST_SHIELD_POSITION__index = "BLAST SHIELD POSITION:index";
        public const string CABLE_CAUGHT_BY_TAILHOOK__index = "CABLE CAUGHT BY TAILHOOK:index";
        public const string CATAPULT_STROKE_POSITION__index = "CATAPULT STROKE POSITION:index";
      ...
      {
        public const string BUS_LOOKUP_INDEX = "BUS LOOKUP INDEX";
        public const string BUS_BREAKER_PULLED = "BUS BREAKER PULLED";
        public const string BUS_CONNECTION_ON = "BUS CONNECTION ON";
        public const string ELECTRICAL_GENALT_LOAD = "ELECTRICAL GENALT LOAD";
        public const string ELECTRICAL_GENALT_BUS_AMPS = "ELECTRICAL GENALT BUS AMPS";
        public const string ELECTRICAL_GENALT_BUS_VOLTAGE = "ELECTRICAL GENALT BUS VOLTAGE";
        public const string ELECTRICAL_MAIN_BUS_VOLTAGE = "ELECTRICAL MAIN BUS VOLTAGE";
        public const string ELECTRICAL_AVIONICS_BUS_AMPS = "ELECTRICAL AVIONICS BUS AMPS";
        public const string ELECTRICAL_AVIONICS_BUS_VOLTAGE = "ELECTRICAL AVIONICS BUS VOLTAGE";
        public const string ELECTRICAL_MAIN_BUS_AMPS = "ELECTRICAL MAIN BUS AMPS";
        public const string ELECTRICAL_OLD_CHARGING_AMPS = "ELECTRICAL OLD CHARGING AMPS";
        public const string ELECTRICAL_TOTAL_LOAD_AMPS = "ELECTRICAL TOTAL LOAD AMPS";
        public const string NEW_ELECTRICAL_SYSTEM = "NEW ELECTRICAL SYSTEM";
        public const string ALTERNATOR_BREAKER_PULLED = "ALTERNATOR BREAKER PULLED";
        public const string ALTERNATOR_CONNECTION_ON = "ALTERNATOR CONNECTION ON";
        public const string GENERAL_ENG_MASTER_ALTERNATOR__index = "GENERAL ENG MASTER ALTERNATOR:index";
        public const string APU_BLEED_PRESSURE_RECEIVED_BY_ENGINE = "APU BLEED PRESSURE RECEIVED BY ENGINE";
        public const string APU_GENERATOR_ACTIVE__index = "APU GENERATOR ACTIVE:index";
        public const string APU_GENERATOR_SWITCH__index = "APU GENERATOR SWITCH:index";
        ...
        public const string APU_VOLTS__index = "APU VOLTS:index";
      ...
      {
        public const string BLEED_AIR_ENGINE__index = "BLEED AIR ENGINE:index";
        public const string BLEED_AIR_SOURCE_CONTROL__index = "BLEED AIR SOURCE CONTROL:index";
        ...
        public const string ENG_ANTI_ICE__index = "ENG ANTI ICE:index";
        public const string ENG_COMBUSTION__index = "ENG COMBUSTION:index";
        public const string ENG_CYLINDER_HEAD_TEMPERATURE__index = "ENG CYLINDER HEAD TEMPERATURE:index";
        public const string ENG_EXHAUST_GAS_TEMPERATURE__index = "ENG EXHAUST GAS TEMPERATURE:index";
        public const string ENG_EXHAUST_GAS_TEMPERATURE_GES__index = "ENG EXHAUST GAS TEMPERATURE GES:index";
        public const string ENG_FAILED__index = "ENG FAILED:index";
        public const string ENG_FUEL_FLOW_BUG_POSITION__index = "ENG FUEL FLOW BUG POSITION:index";
        public const string ENG_FUEL_FLOW_GPH__index = "ENG FUEL FLOW GPH:index";
        public const string ENG_FUEL_FLOW_PPH__index = "ENG FUEL FLOW PPH:index";
        public const string ENG_FUEL_FLOW_PPH_SSL__index = "ENG FUEL FLOW PPH SSL:index";
        public const string ENG_HYDRAULIC_PRESSURE__index = "ENG HYDRAULIC PRESSURE:index";
        public const string ENG_HYDRAULIC_QUANTITY__index = "ENG HYDRAULIC QUANTITY:index";
        public const string ENG_MANIFOLD_PRESSURE__index = "ENG MANIFOLD PRESSURE:index";
        public const string ENG_MAX_RPM = "ENG MAX RPM";
        public const string ENG_N1_RPM__index = "ENG N1 RPM:index";
        public const string ENG_N2_RPM__index = "ENG N2 RPM:index";
        public const string ENG_OIL_PRESSURE__index = "ENG OIL PRESSURE:index";
        public const string ENG_OIL_QUANTITY__index = "ENG OIL QUANTITY:index";
        public const string ENG_OIL_TEMPERATURE__index = "ENG OIL TEMPERATURE:index";
        public const string ENG_ON_FIRE__index = "ENG ON FIRE:index";
        public const string ENG_PRESSURE_RATIO__index = "ENG PRESSURE RATIO:index";
        public const string ENG_PRESSURE_RATIO_GES__index = "ENG PRESSURE RATIO GES:index";
        public const string ENG_RPM_ANIMATION_PERCENT__index = "ENG RPM ANIMATION PERCENT:index";
        public const string ENG_RPM_SCALER__index = "ENG RPM SCALER:index";
        public const string ENG_TORQUE__index = "ENG TORQUE:index";
        public const string ENG_VIBRATION__index = "ENG VIBRATION:index";
        public const string ESTIMATED_FUEL_FLOW__index = "ESTIMATED FUEL FLOW:index";
        public const string FULL_THROTTLE_THRUST_TO_WEIGHT_RATIO = "FULL THROTTLE THRUST TO WEIGHT RATIO";
        public const string GENERAL_ENG_ANTI_ICE_POSITION__index = "GENERAL ENG ANTI ICE POSITION:index";
        public const string GENERAL_ENG_COMBUSTION__index = "GENERAL ENG COMBUSTION:index";
        public const string GENERAL_ENG_COMBUSTION_EX1__index = "GENERAL ENG COMBUSTION EX1:index";
        public const string GENERAL_ENG_COMBUSTION_SOUND_PERCENT__index = "GENERAL ENG COMBUSTION SOUND PERCENT:index";
        public const string GENERAL_ENG_DAMAGE_PERCENT__index = "GENERAL ENG DAMAGE PERCENT:index";
        public const string GENERAL_ENG_ELAPSED_TIME__index = "GENERAL ENG ELAPSED TIME:index";
        public const string GENERAL_ENG_EXHAUST_GAS_TEMPERATURE__index = "GENERAL ENG EXHAUST GAS TEMPERATURE:index";
        public const string GENERAL_ENG_FAILED__index = "GENERAL ENG FAILED:index";
        public const string GENERAL_ENG_FIRE_DETECTED__index = "GENERAL ENG FIRE DETECTED:index";
        public const string GENERAL_ENG_FUEL_PRESSURE__index = "GENERAL ENG FUEL PRESSURE:index";
        public const string GENERAL_ENG_FUEL_PUMP_ON__index = "GENERAL ENG FUEL PUMP ON:index";
        public const string GENERAL_ENG_FUEL_PUMP_SWITCH__index = "GENERAL ENG FUEL PUMP SWITCH:index";
        public const string GENERAL_ENG_FUEL_PUMP_SWITCH_EX1__index = "GENERAL ENG FUEL PUMP SWITCH EX1:index";
        public const string GENERAL_ENG_FUEL_USED_SINCE_START__index = "GENERAL ENG FUEL USED SINCE START:index";
        public const string GENERAL_ENG_FUEL_VALVE__index = "GENERAL ENG FUEL VALVE:index";
        public const string GENERAL_ENG_GENERATOR_ACTIVE__index = "GENERAL ENG GENERATOR ACTIVE:index";
        public const string GENERAL_ENG_GENERATOR_SWITCH__index = "GENERAL ENG GENERATOR SWITCH:index";
        public const string GENERAL_ENG_HOBBS_ELAPSED_TIME__index = "GENERAL ENG HOBBS ELAPSED TIME:index";
        public const string GENERAL_ENG_MASTER_ALTERNATOR = "GENERAL ENG MASTER ALTERNATOR";
        public const string GENERAL_ENG_MAX_REACHED_RPM__index = "GENERAL ENG MAX REACHED RPM:index";
        public const string GENERAL_ENG_MIXTURE_LEVER_POSITION__index = "GENERAL ENG MIXTURE LEVER POSITION:index";
        public const string GENERAL_ENG_OIL_LEAKED_PERCENT__index = "GENERAL ENG OIL LEAKED PERCENT:index";
        public const string GENERAL_ENG_OIL_PRESSURE__index = "GENERAL ENG OIL PRESSURE:index";
        public const string GENERAL_ENG_OIL_TEMPERATURE__index = "GENERAL ENG OIL TEMPERATURE:index";
        public const string GENERAL_ENG_PCT_MAX_RPM__index = "GENERAL ENG PCT MAX RPM:index";
        public const string GENERAL_ENG_PROPELLER_LEVER_POSITION__index = "GENERAL ENG PROPELLER LEVER POSITION:index";
        public const string GENERAL_ENG_REVERSE_THRUST_ENGAGED = "GENERAL ENG REVERSE THRUST ENGAGED";
        public const string GENERAL_ENG_RPM__index = "GENERAL ENG RPM:index";
        public const string GENERAL_ENG_STARTER__index = "GENERAL ENG STARTER:index";
        public const string GENERAL_ENG_STARTER_ACTIVE__index = "GENERAL ENG STARTER ACTIVE:index";
        public const string GENERAL_ENG_THROTTLE_LEVER_POSITION__index = "GENERAL ENG THROTTLE LEVER POSITION:index";
        public const string GENERAL_ENG_THROTTLE_MANAGED_MODE__index = "GENERAL ENG THROTTLE MANAGED MODE:index";
        ...
        public const string PANEL_AUTO_FEATHER_SWITCH__index = "PANEL AUTO FEATHER SWITCH:index";
        public const string PROP_AUTO_CRUISE_ACTIVE = "PROP AUTO CRUISE ACTIVE";
        public const string PROP_AUTO_FEATHER_ARMED__index = "PROP AUTO FEATHER ARMED:index";
        public const string PROP_BETA__index = "PROP BETA:index";
        ...
        public const string PROP_DEICE_SWITCH__index = "PROP DEICE SWITCH:index";
        public const string PROP_FEATHERED__index = "PROP FEATHERED:index";
        public const string PROP_FEATHERING_INHIBIT__index = "PROP FEATHERING INHIBIT:index";
        public const string PROP_FEATHER_SWITCH__index = "PROP FEATHER SWITCH:index";
        public const string PROP_MAX_RPM_PERCENT__index = "PROP MAX RPM PERCENT:index";
        public const string PROP_ROTATION_ANGLE = "PROP ROTATION ANGLE";
        public const string PROP_RPM__index = "PROP RPM:index";
        public const string PROP_SYNC_ACTIVE__index = "PROP SYNC ACTIVE:index";
        public const string PROP_SYNC_DELTA_LEVER__index = "PROP SYNC DELTA LEVER:index";
        public const string PROP_THRUST__index = "PROP THRUST:index";
        public const string PROPELLER_ADVANCED_SELECTION = "PROPELLER ADVANCED SELECTION";
        public const string RECIP_CARBURETOR_TEMPERATURE__index = "RECIP CARBURETOR TEMPERATURE:index";
        public const string RECIP_ENG_ALTERNATE_AIR_POSITION__index = "RECIP ENG ALTERNATE AIR POSITION:index";
        public const string RECIP_ENG_ANTIDETONATION_TANK_MAX_QUANTITY__index = "RECIP ENG ANTIDETONATION TANK MAX QUANTITY:index";
        public const string RECIP_ENG_ANTIDETONATION_TANK_QUANTITY__index = "RECIP ENG ANTIDETONATION TANK QUANTITY:index";
        public const string RECIP_ENG_ANTIDETONATION_TANK_VALVE__index = "RECIP ENG ANTIDETONATION TANK VALVE:index";
        public const string RECIP_ENG_ANTIDETONATION_FLOW_RATE__index = "RECIP ENG ANTIDETONATION FLOW RATE:index";
        public const string RECIP_ENG_BRAKE_POWER__index = "RECIP ENG BRAKE POWER:index";
        public const string RECIP_ENG_COOLANT_RESERVOIR_PERCENT__index = "RECIP ENG COOLANT RESERVOIR PERCENT:index";
        public const string RECIP_ENG_COWL_FLAP_POSITION__index = "RECIP ENG COWL FLAP POSITION:index";
        public const string RECIP_ENG_CYLINDER_HEAD_TEMPERATURE__index = "RECIP ENG CYLINDER HEAD TEMPERATURE:index";
        public const string RECIP_ENG_CYLINDER_HEALTH__index = "RECIP ENG CYLINDER HEALTH:index";
        public const string RECIP_ENG_DETONATING__index = "RECIP ENG DETONATING:index";
        public const string RECIP_ENG_EMERGENCY_BOOST_ACTIVE__index = "RECIP ENG EMERGENCY BOOST ACTIVE:index";
        public const string RECIP_ENG_EMERGENCY_BOOST_ELAPSED_TIME__index = "RECIP ENG EMERGENCY BOOST ELAPSED TIME:index";
        public const string RECIP_ENG_ENGINE_MASTER_SWITCH__index = "RECIP ENG ENGINE MASTER SWITCH:index";
        public const string RECIP_ENG_FUEL_AVAILABLE__index = "RECIP ENG FUEL AVAILABLE:index";
        public const string RECIP_ENG_FUEL_FLOW__index = "RECIP ENG FUEL FLOW:index";
        public const string RECIP_ENG_FUEL_NUMBER_TANKS_USED__index = "RECIP ENG FUEL NUMBER TANKS USED:index";
        public const string RECIP_ENG_FUEL_TANKS_USED__index = "RECIP ENG FUEL TANKS USED:index";
        public const string RECIP_ENG_FUEL_TANK_SELECTOR__index = "RECIP ENG FUEL TANK SELECTOR:index";
        public const string RECIP_ENG_GLOW_PLUG_ACTIVE__index = "RECIP ENG GLOW PLUG ACTIVE:index";
        public const string RECIP_ENG_LEFT_MAGNETO__index = "RECIP ENG LEFT MAGNETO:index";
        public const string RECIP_ENG_MANIFOLD_PRESSURE__index = "RECIP ENG MANIFOLD PRESSURE:index";
        public const string RECIP_ENG_NITROUS_TANK_MAX_QUANTITY__index = "RECIP ENG NITROUS TANK MAX QUANTITY:index";
        public const string RECIP_ENG_NITROUS_TANK_QUANTITY__index = "RECIP ENG NITROUS TANK QUANTITY:index";
        public const string RECIP_ENG_NITROUS_TANK_VALVE = "RECIP ENG NITROUS TANK VALVE";
        public const string RECIP_ENG_NUM_CYLINDERS__index = "RECIP ENG NUM CYLINDERS:index";
        public const string RECIP_ENG_NUM_CYLINDERS_FAILED__index = "RECIP ENG NUM CYLINDERS FAILED:index";
        public const string RECIP_ENG_PRIMER__index = "RECIP ENG PRIMER:index";
        public const string RECIP_ENG_RADIATOR_TEMPERATURE__index = "RECIP ENG RADIATOR TEMPERATURE:index";
        public const string RECIP_ENG_RIGHT_MAGNETO__index = "RECIP ENG RIGHT MAGNETO:index";
        public const string RECIP_ENG_STARTER_TORQUE__index = "RECIP ENG STARTER TORQUE:index";
        public const string RECIP_ENG_SUPERCHARGER_ACTIVE_GEAR__index = "RECIP ENG SUPERCHARGER ACTIVE GEAR:index";
        public const string RECIP_ENG_TURBINE_INLET_TEMPERATURE__index = "RECIP ENG TURBINE INLET TEMPERATURE:index";
        public const string RECIP_ENG_TURBOCHARGER_FAILED__index = "RECIP ENG TURBOCHARGER FAILED:index";
        public const string RECIP_ENG_WASTEGATE_POSITION__index = "RECIP ENG WASTEGATE POSITION:index";
        public const string RECIP_MAX_CHT = "RECIP MAX CHT";
        public const string RECIP_MIXTURE_RATIO__index = "RECIP MIXTURE RATIO:index";
        ...
        public const string TURB_ENG_AFTERBURNER__index = "TURB ENG AFTERBURNER:index";
        public const string TURB_ENG_AFTERBURNER_PCT_ACTIVE__index = "TURB ENG AFTERBURNER PCT ACTIVE:index";
        public const string TURB_ENG_AFTERBURNER_STAGE_ACTIVE__index = "TURB ENG AFTERBURNER STAGE ACTIVE:index";
        public const string TURB_ENG_BLEED_AIR__index = "TURB ENG BLEED AIR:index";
        public const string TURB_ENG_COMMANDED_N1__index = "TURB ENG COMMANDED N1:index";
        public const string TURB_ENG_CONDITION_LEVER_POSITION__index = "TURB ENG CONDITION LEVER POSITION:index";
        public const string TURB_ENG_CORRECTED_FF__index = "TURB ENG CORRECTED FF:index";
        public const string TURB_ENG_CORRECTED_N1__index = "TURB ENG CORRECTED N1:index";
        public const string TURB_ENG_CORRECTED_N2__index = "TURB ENG CORRECTED N2:index";
        public const string TURB_ENG_FREE_TURBINE_TORQUE__index = "TURB ENG FREE TURBINE TORQUE:index";
        public const string TURB_ENG_FUEL_AVAILABLE__index = "TURB ENG FUEL AVAILABLE:index";
        public const string TURB_ENG_FUEL_EFFICIENCY_LOSS__index = "TURB ENG FUEL EFFICIENCY LOSS:index";
        public const string TURB_ENG_FUEL_FLOW_PPH__index = "TURB ENG FUEL FLOW PPH:index";
        public const string TURB_ENG_HIGH_IDLE__index = "TURB ENG HIGH IDLE:index";
        public const string TURB_ENG_IGNITION_SWITCH__index = "TURB ENG IGNITION SWITCH:index";
        public const string TURB_ENG_IGNITION_SWITCH_EX1__index = "TURB ENG IGNITION SWITCH EX1:index";
        public const string TURB_ENG_IS_IGNITING__index = "TURB ENG IS IGNITING:index";
        public const string TURB_ENG_ITT__index = "TURB ENG ITT:index";
        public const string TURB_ENG_ITT_COOLING_EFFICIENCY_LOSS__index = "TURB ENG ITT COOLING EFFICIENCY LOSS:index";
        public const string TURB_ENG_JET_THRUST__index = "TURB ENG JET THRUST:index";
        public const string TURB_ENG_LOW_IDLE__index = "TURB ENG LOW IDLE:index";
        public const string TURB_ENG_MASTER_STARTER_SWITCH = "TURB ENG MASTER STARTER SWITCH";
        public const string TURB_ENG_MAX_TORQUE_PERCENT__index = "TURB ENG MAX TORQUE PERCENT:index";
        public const string TURB_ENG_N1__index = "TURB ENG N1:index";
        public const string TURB_ENG_N1_LOSS__index = "TURB ENG N1 LOSS:index";
        public const string TURB_ENG_N2__index = "TURB ENG N2:index";
        public const string TURB_ENG_NUM_TANKS_USED__index = "TURB ENG NUM TANKS USED:index";
        public const string TURB_ENG_PRESSURE_RATIO__index = "TURB ENG PRESSURE RATIO:index";
        public const string TURB_ENG_PRIMARY_NOZZLE_PERCENT__index = "TURB ENG PRIMARY NOZZLE PERCENT:index";
        public const string TURB_ENG_REVERSE_NOZZLE_PERCENT__index = "TURB ENG REVERSE NOZZLE PERCENT:index";
        public const string TURB_ENG_TANKS_USED__index = "TURB ENG TANKS USED:index";
        public const string TURB_ENG_TANK_SELECTOR__index = "TURB ENG TANK SELECTOR:index";
        public const string TURB_ENG_THROTTLE_COMMANDED_N1__index = "TURB ENG THROTTLE COMMANDED N1:index";
        public const string TURB_ENG_THRUST_EFFICIENCY_LOSS__index = "TURB ENG THRUST EFFICIENCY LOSS:index";
        public const string TURB_ENG_VIBRATION__index = "TURB ENG VIBRATION:index";
      ...
      public static class FlightModel
      {
        ...
        public const string WING_FLEX_PCT__index = "WING FLEX PCT:index";
      ...
      {
        public const string FUEL_CROSS_FEED__index = "FUEL CROSS FEED:index";
        ...
        public const string FUEL_SELECTED_QUANTITY__index = "FUEL SELECTED QUANTITY:index";
        public const string FUEL_SELECTED_QUANTITY_PERCENT__index = "FUEL SELECTED QUANTITY PERCENT:index";
        ...
        public const string FUEL_TRANSFER_PUMP_ON__index = "FUEL TRANSFER PUMP ON:index";
        ...
        public const string FUELSYSTEM_ENGINE_PRESSURE__index = "FUELSYSTEM ENGINE PRESSURE:index";
        public const string FUELSYSTEM_JUNCTION_SETTING__index = "FUELSYSTEM JUNCTION SETTING:index";
        public const string FUELSYSTEM_LINE_FUEL_FLOW__index = "FUELSYSTEM LINE FUEL FLOW:index";
        public const string FUELSYSTEM_LINE_FUEL_LEVEL__index = "FUELSYSTEM LINE FUEL LEVEL:index";
        public const string FUELSYSTEM_LINE_FUEL_PRESSURE__index = "FUELSYSTEM LINE FUEL PRESSURE:index";
        public const string FUELSYSTEM_PUMP_ACTIVE__index = "FUELSYSTEM PUMP ACTIVE:index";
        public const string FUELSYSTEM_PUMP_SWITCH__index = "FUELSYSTEM PUMP SWITCH:index";
        public const string FUELSYSTEM_TANK_CAPACITY__index = "FUELSYSTEM TANK CAPACITY:index";
        public const string FUELSYSTEM_TANK_LEVEL__index = "FUELSYSTEM TANK LEVEL:index";
        public const string FUELSYSTEM_TANK_QUANTITY__index = "FUELSYSTEM TANK QUANTITY:index";
        public const string FUELSYSTEM_TANK_TOTAL_QUANTITY__index = "FUELSYSTEM TANK TOTAL QUANTITY:index";
        public const string FUELSYSTEM_TANK_WEIGHT__index = "FUELSYSTEM TANK WEIGHT:index";
        public const string FUELSYSTEM_TRIGGER_STATUS__index = "FUELSYSTEM TRIGGER STATUS:index";
        public const string FUELSYSTEM_VALVE_OPEN__index = "FUELSYSTEM VALVE OPEN:index";
        public const string FUELSYSTEM_VALVE_SWITCH__index = "FUELSYSTEM VALVE SWITCH:index";
        ...
        public const string FUEL_TANK_SELECTOR__index = "FUEL TANK SELECTOR:index";
      }
      public static class RadioAndNavigation
      {
        public const string ADF_ACTIVE_FREQUENCY__index = "ADF ACTIVE FREQUENCY:index";
        public const string ADF_AVAILABLE__index = "ADF AVAILABLE:index";
        public const string ADF_CARD = "ADF CARD";
        public const string ADF_IDENT = "ADF IDENT";
        public const string ADF_LATLONALT__index = "ADF LATLONALT:index";
        public const string ADF_NAME__index = "ADF NAME:index";
        public const string ADF_RADIAL__index = "ADF RADIAL:index";
        public const string ADF_RADIAL_MAG__index = "ADF RADIAL MAG:index";
        public const string ADF_SIGNAL__index = "ADF SIGNAL:index";
        public const string ADF_SOUND__index = "ADF SOUND:index";
        public const string ADF_STANDBY_AVAILABLE__index = "ADF STANDBY AVAILABLE:index";
        public const string ADF_STANDBY_FREQUENCY__index = "ADF STANDBY FREQUENCY:index";
        ...
        public const string COM_ACTIVE_BEARING__index = "COM ACTIVE BEARING:index";
        public const string COM_ACTIVE_DISTANCE__index = "COM ACTIVE DISTANCE:index";
        public const string COM_ACTIVE_FREQUENCY__index = "COM ACTIVE FREQUENCY:index";
        public const string COM_ACTIVE_FREQ_IDENT__index = "COM ACTIVE FREQ IDENT:index";
        public const string COM_ACTIVE_FREQ_TYPE__index = "COM ACTIVE FREQ TYPE:index";
        public const string COM_ACTIVE_LATLONALT__index = "COM ACTIVE LATLONALT:index";
        public const string COM_AVAILABLE__index = "COM AVAILABLE:index";
        public const string COM_RECEIVE__index = "COM RECEIVE:index";
        public const string COM_RECEIVE_ALL = "COM RECEIVE ALL";
        public const string COM_RECEIVE_EX1__index = "COM RECEIVE EX1:index";
        public const string COM_SPACING_MODE__index = "COM SPACING MODE:index";
        public const string COM_STANDBY_FREQUENCY__index = "COM STANDBY FREQUENCY:index";
        public const string COM_STANDBY_FREQ_IDENT__index = "COM STANDBY FREQ IDENT:index";
        public const string COM_STANDBY_FREQ_TYPE__index = "COM STANDBY FREQ TYPE:index";
        public const string COM_STATUS__index = "COM STATUS:index";
        public const string COM_TEST__index = "COM TEST:index";
        public const string COM_TRANSMIT__index = "COM TRANSMIT:index";
        ...
        public const string NAV_ACTIVE_FREQUENCY__index = "NAV ACTIVE FREQUENCY:index";
        public const string NAV_AVAILABLE__index = "NAV AVAILABLE:index";
        public const string NAV_BACK_COURSE_FLAGS__index = "NAV BACK COURSE FLAGS:index";
        public const string NAV_CDI__index = "NAV CDI:index";
        public const string NAV_CLOSE_DME__index = "NAV CLOSE DME:index";
        public const string NAV_CLOSE_FREQUENCY__index = "NAV CLOSE FREQUENCY:index";
        public const string NAV_CLOSE_IDENT__index = "NAV CLOSE IDENT:index";
        public const string NAV_CLOSE_LOCALIZER__index = "NAV CLOSE LOCALIZER:index";
        public const string NAV_CLOSE_NAME__index = "NAV CLOSE NAME:index";
        public const string NAV_CODES = "NAV CODES";
        public const string NAV_DME = "NAV DME";
        public const string NAV_DMESPEED = "NAV DMESPEED";
        public const string NAV_DME_LATLONALT__index = "NAV DME LATLONALT:index";
        ...
        public const string NAV_GS_LATLONALT__index = "NAV GS LATLONALT:index";
        ...
        public const string NAV_SOUND__index = "NAV SOUND:index";
        public const string NAV_STANDBY_FREQUENCY__index = "NAV STANDBY FREQUENCY:index";
        ...
        public const string NAV_VOR_LATLONALT__index = "NAV VOR LATLONALT:index";
        public const string NAV_VOR_LLAF64 = "NAV VOR LLAF64";
        public const string TACAN_ACTIVE_CHANNEL__index = "TACAN ACTIVE CHANNEL:index";
        public const string TACAN_ACTIVE_MODE__index = "TACAN ACTIVE MODE:index";
        public const string TACAN_AVAILABLE__index = "TACAN AVAILABLE:index";
        public const string TACAN_DRIVES_NAV1__index = "TACAN DRIVES NAV1:index";
        public const string TACAN_OBS__index = "TACAN OBS:index";
        public const string TACAN_STANDBY_CHANNEL__index = "TACAN STANDBY CHANNEL:index";
        public const string TACAN_STANDBY_MODE__index = "TACAN STANDBY MODE:index";
        public const string TACAN_STATION_CDI__index = "TACAN STATION CDI:index";
        public const string TACAN_STATION_DISTANCE__index = "TACAN STATION DISTANCE:index";
        public const string TACAN_STATION_IDENT__index = "TACAN STATION IDENT:index";
        public const string TACAN_STATION_LATLONALT__index = "TACAN STATION LATLONALT:index";
        public const string TACAN_STATION_RADIAL__index = "TACAN STATION RADIAL:index";
        public const string TACAN_STATION_RADIAL_ERROR__index = "TACAN STATION RADIAL ERROR:index";
        public const string TACAN_STATION_TOFROM__index = "TACAN STATION TOFROM:index";
        public const string TACAN_VOLUME__index = "TACAN VOLUME:index";
        ...
        public const string TRANSPONDER_CODE__index = "TRANSPONDER CODE:index";
      ...
      public static class Systems
      {
        ...
        public const string ALTERNATE_STATIC_SOURCE_OPEN__index = "ALTERNATE STATIC SOURCE OPEN:index";
        ...
        public const string AVIONICS_MASTER_SWITCH__index = "AVIONICS MASTER SWITCH:index";
        ...
        public const string KOHLSMAN_SETTING_HG__index = "KOHLSMAN SETTING HG:index";
        public const string KOHLSMAN_SETTING_MB__index = "KOHLSMAN SETTING MB:index";
        public const string KOHLSMAN_SETTING_STD__index = "KOHLSMAN SETTING STD:index";
        ...
        public const string PITOT_HEAT_SWITCH__index = "PITOT HEAT SWITCH:index";
        public const string PLANE_HEADING_DEGREES_GYRO = "PLANE HEADING DEGREES GYRO";
        ...
        public const string WATER_BALLAST_TANK_CAPACITY__index = "WATER BALLAST TANK CAPACITY:index";
        public const string WATER_BALLAST_TANK_NUMBER = "WATER BALLAST TANK NUMBER";
        public const string WATER_BALLAST_TANK_QUANTITY__index = "WATER BALLAST TANK QUANTITY:index";
        ...
        public const string LIGHT_POTENTIOMETER__index = "LIGHT POTENTIOMETER:index";
        ...
        public const string HYDRAULIC_PRESSURE__index = "HYDRAULIC PRESSURE:index";
        public const string HYDRAULIC_RESERVOIR_PERCENT__index = "HYDRAULIC RESERVOIR PERCENT:index";
        ...
        public const string DROPPABLE_OBJECTS_COUNT__index = "DROPPABLE OBJECTS COUNT:index";
        public const string DROPPABLE_OBJECTS_TYPE__index = "DROPPABLE OBJECTS TYPE:index";
        public const string DROPPABLE_OBJECTS_UI_NAME__index = "DROPPABLE OBJECTS UI NAME:index";
        public const string PAYLOAD_STATION_COUNT = "PAYLOAD STATION COUNT";
        public const string PAYLOAD_STATION_NAME__index = "PAYLOAD STATION NAME:index";
        public const string PAYLOAD_STATION_NUM_SIMOBJECTS__index = "PAYLOAD STATION NUM SIMOBJECTS:index";
        public const string PAYLOAD_STATION_OBJECT__index = "PAYLOAD STATION OBJECT:index";
        public const string PAYLOAD_STATION_WEIGHT__index = "PAYLOAD STATION WEIGHT:index";
    ...
    {
      public const string ANIMATION_DELTA_TIME = "ANIMATION DELTA TIME";
      public const string ARTIFICIAL_GROUND_ELEVATION = "ARTIFICIAL GROUND ELEVATION";
      public const string CATEGORY = "CATEGORY";
      public const string CONTROLLABLE = "CONTROLLABLE";
      public const string CRASH_FLAG = "CRASH FLAG";
      public const string CRASH_SEQUENCE = "CRASH SEQUENCE";
      public const string GROUND_ALTITUDE = "GROUND ALTITUDE";
      public const string HAND_ANIM_STATE = "HAND ANIM STATE";
      public const string IDLE_ANIMATION_ID = "IDLE ANIMATION ID";
      public const string MAGVAR = "MAGVAR";
      public const string MISSION_SCORE = "MISSION SCORE";
      public const string REALISM = "REALISM";
      public const string REALISM_CRASH_DETECTION = "REALISM CRASH DETECTION";
      public const string REALISM_CRASH_WITH_OTHERS = "REALISM CRASH WITH OTHERS";
      public const string SIM_DISABLED = "SIM DISABLED";
      public const string SIM_ON_GROUND = "SIM ON GROUND";
      public const string SIM_SHOULD_SET_ON_GROUND = "SIM SHOULD SET ON GROUND";
      public const string TRACK_IR_ENABLE = "TRACK IR ENABLE";
      public const string TOTAL_WORLD_VELOCITY = "TOTAL WORLD VELOCITY";
      public const string USER_INPUT_ENABLED = "USER INPUT ENABLED";
      public const string VISUAL_MODEL_RADIUS = "VISUAL MODEL RADIUS";
      public const string VELOCITY_WORLD_X = "VELOCITY WORLD X";
      public const string VELOCITY_WORLD_Y = "VELOCITY WORLD Y";
      public const string VELOCITY_WORLD_Z = "VELOCITY WORLD Z";
      public const string AMBIENT_DENSITY = "AMBIENT DENSITY";
      public const string AMBIENT_PRECIP_RATE = "AMBIENT PRECIP RATE";
      public const string AMBIENT_PRECIP_STATE = "AMBIENT PRECIP STATE";
      public const string AMBIENT_PRESSURE = "AMBIENT PRESSURE";
      public const string AMBIENT_TEMPERATURE = "AMBIENT TEMPERATURE";
      public const string AMBIENT_VISIBILITY = "AMBIENT VISIBILITY";
      ...
      public const string BAROMETER_PRESSURE = "BAROMETER PRESSURE";
      public const string SEA_LEVEL_PRESSURE = "SEA LEVEL PRESSURE";
      public const string STRUCT_AMBIENT_WIND = "STRUCT AMBIENT WIND";
      public const string AI_DESIRED_SPEED = "AI DESIRED SPEED";
      public const string AI_WAYPOINT_LIST = "AI WAYPOINT LIST";
      public const string AI_CURRENT_WAYPOINT = "AI CURRENT WAYPOINT";
      public const string AI_DESIRED_HEADING = "AI DESIRED HEADING";
      public const string AI_GROUNDTURNTIME = "AI GROUNDTURNTIME";
      public const string AI_GROUNDCRUISESPEED = "AI GROUNDCRUISESPEED";
      public const string AI_GROUNDTURNSPEED = "AI GROUNDTURNSPEED";
      public const string AI_TRAFFIC_ISIFR = "AI TRAFFIC ISIFR";
      public const string AI_TRAFFIC_STATE = "AI TRAFFIC STATE";
      public const string AI_TRAFFIC_CURRENT_AIRPORT = "AI TRAFFIC CURRENT AIRPORT";
      public const string AI_TRAFFIC_ASSIGNED_RUNWAY = "AI TRAFFIC ASSIGNED RUNWAY";
      public const string AI_TRAFFIC_ASSIGNED_PARKING = "AI TRAFFIC ASSIGNED PARKING";
      public const string AI_TRAFFIC_FROMAIRPORT = "AI TRAFFIC FROMAIRPORT";
